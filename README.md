...
**Status:** Phase 2 passed on two phones. Phases 3–5 built (relay, SOS, meet halfway, compass, lighthouse, field log with CSV export, stats, radio settings, OEM battery help); three-phone relay, five-phone park and dense-crowd tests pending — see `docs/ROADMAP.md`. Target pilot: Lollapalooza India 2027.
