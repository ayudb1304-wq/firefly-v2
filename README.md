...
**Status:** Phase 2 built (codebook pings with ACKs, timeline, names, QR join); Phase 2 exit test on two phones pending — see `docs/ROADMAP.md`. Target pilot: Lollapalooza India 2027.
